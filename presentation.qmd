...
-   The question is, **how**?  What does it mean to **see** uncertainty?

# Chapter 2: What are we trying to do?

## Theory and code
- There are really two elements of this problem
1. Theoretically, what does it mean to visualise uncertainty
  - Existing discussions are kind of vague on our goals
2. Practically, how should the system be designed
  - Existing implementations are specific to one type of plot and use bespoke syntax

## Theory - Visual statistical properties

::::: columns
::: {.column width="40%"}
-   Statistical properties are what differentiate us from the animals
-   Sweet succulent statistical properties
:::
...
## Theory - Broad goals of the system
-   Statistical validity should translates to perceptual ease
    -   The higher the variance on an estimate, the harder that estimate is to extract from the plot
...
# Chapter 3: A Teeny Tiny Spatial Example
...
# Chapter 4: A State of Mainia and `ggdibbler`
